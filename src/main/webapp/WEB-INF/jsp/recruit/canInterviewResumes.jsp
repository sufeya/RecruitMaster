	...
	<div id="header">
    	<div class="wrapper">
    		...
    		<ul id="navheader" class="reset">
            		...
            		<i></i>
                                	...
                                	<dd><a rel="nofollow" href="../interviewer/jianli.html">我的简历</a></dd>
                	                	<dd><a href="../interviewer/collections.html">我收藏的职位</a></dd>
                	                	                	<dd><a href="../interviewer/delivery.html">我投递的职位 <span id="noticeNo" class="red">(1)</span></a></dd>
            	...
            	<span class="bot"></span>
				<span class="top"></span>
				<a target="_blank" href="../interviewer/delivery.html"><strong>1</strong>条新投递反馈</a>
