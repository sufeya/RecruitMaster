	...
	<div id="header">
    	<div class="wrapper">
    		...
    		<ul id="navheader" class="reset">
    			...
    			<li class="current"><a href="../recruit/companylist.html">公司</a></li>
    			<li><a target="_blank" href="">论坛</a></li>
    				    			<li>
	    				<a rel="nofollow" href="">简历管理</a>
	    					    			</li>
	    							    			<li><a rel="nofollow" href="../recruit/create.html">发布职位</a></li>
	    		    		</ul>
            	...
            	<dt>
            		...
            		<i></i>
                                	...
                                	<dd><a href="../recruit/positions.html">我发布的职位</a></dd>
                	<dd><a href="../recruit/positions.html">我收到的简历</a></dd>
                	<dd class="btm"><a href="myhome.html">我的公司主页</a></dd>
                	<dd><a href="../interviewer/jianli.html">我要找工作</a></dd>
    ...
    <div id="container">
        ...
        <div class="content_mid">
            <dl class="c_section c_section_mid">
                <dt>
                    <h2><em></em>填写公司信息</h2>
                    <a class="c_addjob" href="../recruit/create.html"><i></i>发布新职位</a>
                </dt>
                <dd>
