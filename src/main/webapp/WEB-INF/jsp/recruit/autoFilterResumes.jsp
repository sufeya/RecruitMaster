...
<div id="body">
    ...
    <div id="container">
                	<div class="sidebar">
        		            	<a class="btn_create" href="../recruit/create.html">发布新职位</a>
	...
	<dd>
		<a href="../recruit/haveRefuseResumes.html">不合适简历</a>
	</dd>
...
<dl class="company_center_aside">
		<dt>我发布的职位</dt>
			<dd>
		<a href="../recruit/positions.html">有效职位</a>
	</dd>
	<dd>
		<a href="../recruit/positions.html">已下线职位</a>
	</dd>
	</dl>
            </div><!-- end .sidebar -->
            <div class="content">
