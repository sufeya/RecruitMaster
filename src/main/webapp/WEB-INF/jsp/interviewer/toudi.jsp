    	...
    	<div class="wrapper">
    		...
    		<ul id="navheader" class="reset">
    			...
    			<li><a target="_blank" href="h/toForum.html">论坛</a></li>
    				    			<li>
	    				<a rel="nofollow" href="../interviewer/jianli.html">我的简历</a>
	    					    			</li>
            	...
            	<dt>
                	...
                	<dd class="btm" style="display: none;"><a href="../company/myhome.html">我的公司主页</a></dd>
                	<dd style="display: none;"><a href="../list.html">我要找工作</a></dd>
                                                <dd style="display: none;"><a href="../interviewer/accountBind.html">帐号设置</a></dd>
                    ...
                    <dt>
                        <h1 title="产品经理">
                            <em></em>
                       			...
                       			<span>已成功收藏该职位，</span>
								<a class="jd_collection_page" href="../interviewer/collections.html">查看全部</a>
...
<p>3、每周定期举办足球、羽毛球、篮球及员工深度互动等文体活动。</p>
				                        ...
				                        <div>
								          <span> 你已有可投递的在线简历：<a title="jason的简历" target="_blank" href="../interviewer/jianli.html"><strong>jason的简历</strong></a></span><br>
								          <span>简历更新于2014-07-01 15:53</span>
				                        </div>
				                        <span class="setBtns">
				                        	<a target="_blank" title="预览" href="h/resume/preview.html">预览</a> |
				                        	<a title="修改" target="_blank" href="../interviewer/jianli.html">修改</a>
				                        </span>
				                    </dd>
	        	...
	        	<td>
                    <form class="resumeSetForm" id="resumeSetForm">
            			...
            			<div class="setBtns">
	            										...
	            										<a target="_blank" href="../interviewer/jianli.html">修改</a>
            			</div>
	            		<div class="clear"></div>
	            		<label class="radio">
	    	...
	    	<tr>
	        	<td align="center">
                   <form>
                    ...
                    <a target="_blank" href="../interviewer/jianli.html" class="btn">完善在线简历</a>
	            </td>
	        </tr>
	    </tbody></table>
	</div><!--/#sendNoResume-->
