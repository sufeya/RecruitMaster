            		...
            		<i></i>
                                	...
                                	<dd style="display: none;"><a rel="nofollow" href="jianli.html">我的简历</a></dd>
                	                	<dd style="display: none;"><a href="collections.html">我收藏的职位</a></dd>
                	                	                	<dd style="display: none;"><a href="../recruit/toudi.html">我投递的职位 <span id="noticeNo" class="red dn">(0)</span></a></dd>
                	                	<dd class="btm" style="display: none;"><a href="subscribe.html">我的订阅</a></dd>
                	<dd style="display: none;"><a href="../recruit/create.html">我要招人</a></dd>
        ...
        <div class="clearfix">
            ...
            <div class="content_r">
            	<div class="mycenterR" id="myInfo">
            		...
            		<br>
            		            		<a href="../recruit/toudi.html" target="_blank">我投递的职位<span id="noticeNoPage" class="red dn">&nbsp;(0)</span></a>
            		<br>
