...
<div id="previewWrapper">
    <div class="preview_header">
        <h1 title="jason的简历">${userTail.uName}的简历</h1>
    ...
    <div class="preview_content">
        <div class="profile_box" id="basicInfo">
            ...
            <div class="basicShow">
                   <span>${userTail.uName} |
                    ${userTail.uSex} |                     ${resume.eb.degree} |                                       		3年工作经验
            		            			| ${resume.cos.preferredLocation}<br>
            			            				${resume.wes.jobTitle} · ${resume.wes.company} | ${resume.eb.degree} · ${resume.eb.school}<br>
            			            			${userTail.uMobile} | ${userTail.uEmail}<br>
            			
            		</span>
               图片 ${userTail.uImg}
                <div class="m_portrait">
                    <div></div>
                    <img width="120" height="120" alt="jason" src="/${userTail.uImg}">
                </div>
            </div><!--end .basicShow-->
        </div><!--end #basicInfo-->
        ...
        <div class="profile_box" id="expectJob">
            ...
            <div class="expectShow">
                ${resume.cos.preferredLocation}，${resume.cos.jobType}，${resume.cos.salaryExpection}，${resume.cos.preferredFunction}
            </div><!--end .expectShow-->
        </div><!--end #expectJob-->
        ...
        <div class="profile_box" id="workExperience">
            ...
            <div class="experienceShow">
                <ul class="wlist clearfix">
                    <li class="clear">
                        <span class="c9">${resume.wes.startTime}-${resume.wes.endTime}</span>
                        <div>
                            <img width="56" height="56" alt="${resume.wes.company}" src="../style/images/logo_default.png">
                            <h3>${resume.wes.jobTitle}</h3>
                            <h4>${resume.wes.company}</h4>
                        </div>
                    </li>
                </ul>
                ...
                <ul class="plist clearfix">
                    <li class="noborder">
                        <div class="projectList">
                            <div class="f16 mb10">${resume.pe.projectName}，${resume.pe.personalDuty}
                                <span class="c9">
		            									            								（${resume.pe.periodStart}-${resume.pe.periodEnd}）
		            									            						</span>
                            </div>
                            <div class="dl1"></div>
                        </div>
            ...
            <div class="educationalShow">
                <ul class="elist clearfix">
                    <li class="clear">
                        ...
                        <div>
                            <h3>${resume.eb.school}</h3>
                            <h4>${resume.eb.major}，${resume.eb.degree}</h4>
                        </div>
                    </li>
                </ul>
                    ...
                    <li class="noborder">
                        <div class="workList c7">
                            <div class="f16">网址：<a target="_blank"
                                                   href="${resume.wd.workUrl}">${resume.wd.workUrl}</a></div>
                            <p>产品 </p>
                        </div>
                    </li>
                </ul>
