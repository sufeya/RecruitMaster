    	...
    	<div class="wrapper">
    		...
    		<ul id="navheader" class="reset">
    			...
    			<li><a target="_blank" href="">论坛</a></li>
    				    			<li><a rel="nofollow" href="interviewer/jianli.html">我的简历</a></li>
	    						    		</ul>
            	...
            	<dt>
            		...
            		<i></i>
                                	...
                                	<dd><a rel="nofollow" href="interviewer/jianli.html">我的简历</a></dd>
                	                	<dd><a href="interviewer/collections.html">我收藏的职位</a></dd>
                	                	                	<dd><a href="interviewer/delivery.html">我投递的职位 <span id="noticeNo" class="red dn">(0)</span></a></dd>
                	                	<dd class="btm"><a href="interviewer/subscribe.html">我的订阅</a></dd>
                	<dd><a href="recruit/create.html">我要招人</a></dd>
                                                <dd><a href="interviewer/accountBind.html">帐号设置</a></dd>
                                <dd class="logout"><a rel="nofollow" href="login.html">退出</a></dd>
            </dl>
                                    <div class="dn" id="noticeTip">
            	<span class="bot"></span>
				<span class="top"></span>
				<a target="_blank" href="interviewer/delivery.html"><strong>0</strong>条新投递反馈</a>
    ...
    <div id="container">
        ...
        <div class="clearfix">
            <div class="content_l recommend_list">
            	<h2>拉勾网根据你的个人简历为你推荐以下职位： <a class="more" href="interviewer/jianli.html">修改简历信息&gt;&gt;</a></h2>
            ...
            <div class="content_r">
            	<div class="subscribe_side">
	            	<a target="_blank" href="interviewer/subscribe.html">
...
$(function(){
	...
	<div id="footer">
		<div class="wrapper">
			<a rel="nofollow" target="_blank" href="company/about.html">联系我们</a>
