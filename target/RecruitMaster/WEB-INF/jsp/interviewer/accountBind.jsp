...
<div id="body">
    	...
    	<div class="wrapper">
    		...
    		<ul id="navheader" class="reset">
    			...
    			<li><a target="_blank" href="h/toForum.html">论坛</a></li>
    				    			<li>
	    				<a rel="nofollow" href="../recruit/positions.html">简历管理</a>
	    					    			</li>
            	...
            	<dt>
            		...
            		<i></i>
                                	...
                                	<dd style="display: none;"><a href="../recruit/positions.html">我发布的职位</a></dd>
                	<dd style="display: none;"><a href="../recruit/positions.html">我收到的简历</a></dd>
    ...
    <dl id="user_sideBarmenu" class="user_sideBarmenu">
        ...
        <dd><a href="../company/updatePwd.html">修改密码</a></dd>
            </dl>
</div>
