...
<head>
    ...
    <script src="/style/js/userTailUpload.js" type="text/javascript"></script>
    ...
    <div id="header">
        <div class="wrapper">
            ...
            <dl class="collapsible_menu">
                <dt>
                    <span>&nbsp;<c:if test="${userTail !=null}">${userTail.uName}</c:if> <c:if test="${userTail ==null}">xxxx</c:if></span>
                ...
                <dd><a href="../recruit/create.html">我要招人</a></dd>
            ...
            <div class="content_l">
                <div class="fl" id="resume_name">
                    <div class="nameShow fl">
                        <h1 title="jason的简历">xxxx的简历</h1>
                        <span class="rename">重命名</span> | <a target="_blank" href="/resume/showResume">预览</a>
                    </div>
                ...
                <div class="profile_box" id="basicInfo">
                    ...
                    <div class="basicShow">
            			            			<span><c:if test="${userTail !=null}">${userTail.uName}</c:if><c:if test="${userTail ==null}">xxxx</c:if> |  ${userTail.uSex} |    大专 |  3年工作经验<br>
                    ...
                    <div class="basicEdit dn">
                        ...
                        <form id="profileForm" >
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" placeholder="姓名" value="jason" name="uName" id="name">
                                    </td>
                                    <td valign="top"></td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="hidden" id="topDegree" value="大专" name="uEducation">
                                    ...
                                    <td>
                                        <input type="hidden" id="workyear" value="" name="uWorkyear">
                                ...
                                <tr>
                                    ...
                                    <td colspan="3">
                                        <input type="text" placeholder="手机号码" value="18644444444" name="uMobile" id="tel">
                                    </td>
                                </tr>
                                <tr>
                                    <td valign="top">
                                    ...
                                    <td colspan="3">
                                        <input type="text" placeholder="接收面试通知的邮箱" value="jason@qq.com" name="uEmail"
                                               id="email">
                                    </td>
                                </tr>
                                <tr>
                                    <td valign="top"></td>
                                    <td colspan="3">
                                        <input type="hidden" id="currentState" value="" name="uStatu">
                        ...
                        <div class="new_portrait">
                            ...
                            <input type="file" value="" title="支持jpg、jpeg、gif、png格式，文件小于5M"
                                   onchange="img_check(this,'/resume/getImg','headPic');" name="headPic"
                    ...
                    <input type="hidden" id="nameVal" value="男">
                    ...
                    <div class="expectEdit dn">
                        <form id="expectForm">
                            <table>
                                ...
                                <tr>
                                    <td>
                                        <input type="hidden" id="expectCity" value="" name="preferredLocation">
                                    ...
                                    <td>
                                        <ul class="profile_radio clearfix reset">
                                            <li class="current">
                                                全职<em></em>
                                                <input type="radio" checked="" name="jobType" value="全职">
                                            </li>
                                            <li>
                                                兼职<em></em>
                                ...
                                <tr>
                                    <td>
                                        <input type="text" placeholder="期望职位，如：产品经理" value="" name="preferredFunction"
                                               id="expectPosition">
                                    </td>
                                    <td>
                                        <input type="hidden" id="expectSalary" value="" name="salaryExpection">
