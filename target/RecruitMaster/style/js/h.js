(function () {
    ...
    };var aa = navigator.cookieEnabled, ba = navigator.javaEnabled(),
        ha = navigator.language || navigator.browserLanguage || navigator.systemLanguage || navigator.userLanguage || "",
        ia = window.screen.width + "x" + window.screen.height, ja = window.screen.colorDepth;
    var O = 0, P = Math.round(+new Date / 1E3), Q = "https:" == document.location.protocol ? "https:" : "http:",
    ...
    function ka(a) {
        try {
            ...
            if (document.referrer) {
                var u = n;
                if (Y(document.referrer) && Y(document.location.href)) u = l; else var pa = v(document.referrer),
            ...
            0 == a.a.nv ? oa() : X(".*");
            if ("" != c.icon) {
                var r, s = c.icon.split("|"), S = "http://tongji.baidu.com/hm-web/welcome/ico?s=" + c.id,
            ...
            var K = document.location.hash.substring(1), ua = RegExp(c.id),
