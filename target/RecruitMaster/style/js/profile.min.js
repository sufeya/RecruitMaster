...
function img_check(a, b, c) {
    ...
    this.AllowExt = ".jpg,.gif,.jpeg,.png,.pjpeg", this.FileExt = a.val().substr(a.val().lastIndexOf(".")).toLowerCase(), 0 != this.AllowExt && -1 == this.AllowExt.indexOf(this.FileExt) ? errorTips("只支持jpg、gif、png、jpeg格式，请重新上传", "上传头像") : ($("#" + c + "_error").text("").hide(), $.ajaxFileUpload({
        ...
        success: function (a) {
            ...
            if (a.success) {
                var b = a.content;
                $("#portraitShow img").attr("src", "../"+b), $("#basicInfo .basicShow img").attr("src",  "../" + b), $("#portraitNo").hide(), $("#portraitShow").show()
...
!function (a, b) {
        ...
        $(".projectForm").each(function () {
            $(this).validate({
                ...
                submitHandler: function (a) {
                    ...
                    var json=JSON.stringify({projectName:b,personalDuty:c,periodStart:e+"-"+f,periodEnd: g+"-"+h,projectDesc: i});
                    alert(json);
                    $(a).find(":submit").val("保存中...").attr("disabled", !0), $.ajax({
                        url:"/resume/getProjectExperience",
                        type: "POST",
                        ...
                        var c, e;
                        $("#resubmitToken").val(b.resubmitToken), b.success ? (c = b.projectExperience, e = "", 3 == 3? "" != c ? (e += '<li data-id="' + c.id + '">', e += '<div class="projectList"><i class="sm_del dn"></i><i class="sm_edit dn"></i><div class="f16 mb10" data-proName="' + c.projectName + '" data-posName="' + c.personalDuty + '" data-startY="' + c.periodStart.split("-")[0] + '" data-startM="' + c.periodStart.split("-")[1] + '" data-endY="' + c.periodEnd.split("-")[0] + '"' + 'data-endM="' + c.periodEnd.split("-")[1] + '">' + c.projectName + '<span class="c9">（' + c.periodStart + "-" + c.periodEnd + "）</span></div>", "" != c.projectName && (e += '<div class="dl1">' + c.projectDesc + "</div>"), e += "</div></li>", "" != $.trim(d.obj.children(".projectShow").children(".plist").html()) && $(a).remove(), d.obj.children(".c_add").removeClass("dn"), d.obj.children(".projectShow").children(".plist").prepend(e), d.obj.children(".projectShow").removeClass("dn"), d.obj.children(".projectEdit").addClass("dn")) : "" != $.trim(d.obj.children(".projectShow").children(".plist").html()) ? ($(a).remove(), d.obj.children(".c_add").removeClass("dn")) : (d.obj.children(".projectEdit").addClass("dn"), d.obj.children(".projectAdd").removeClass("dn")) : 4 == 4 ? (e += '<div class="projectList"><i class="sm_del dn"></i><i class="sm_edit dn"></i><div class="f16 mb10" data-proName="' + c.projectName + '" data-posName="' + c.positionName + '" data-startY="' + c.periodStart.split("-")[0] + '" data-startM="' + c.periodStart.split("-")[1] + '" data-endY="' + c.periodEnd.split("-")[0] + '"' + 'data-endM="' + c.periodEnd.split("-")[1] + '">' + c.projectDesc + '<span class="c9">（' + c.periodStart + "-" + c.periodEnd + "）</span></div>", "" != c.projectDesc && (e += '<div class="dl1">' + c.projectDesc + "</div>"), e += "</div>", $(a).parent("li").html(e)) : 2 == 2 && ($(a).parent("li").remove(), 0 == d.obj.children(".projectShow").children(".plist").children("li").length && d.AddCancel), d.obj.find(".plist li:last-child").addClass("noborder"), $("#lastChangedTime span").text(b.refreshTime), $("#resumeScore .which div").text(b.msg), $("#resumeScore .which span").attr("rel", b.nextStage), scoreChange(b.score), k(d.obj), b.isNew && changeAllIds(b.jsonIds)) : alert(b.msg), $(a).find(":submit").val("保 存").attr("disabled", !1)
                    })
                }
            })
        })
        ...
        $(".workForm").each(function () {
            $(this).validate({
                ...
                submitHandler: function (a) {
                    ...
                    var json=JSON.stringify({workUrl:b,workDescription:c});
                    alert(json);
                    $(a).find(":submit").val("保存中...").attr("disabled", !0), $.ajax({
                        url:"/resume/getWorkDisplay",
                        contentType :"application/json;charset=UTF-8",
                        type: "POST",
                        data: json,
                        dataType: "json"
                        ...
                        var c, d, e;
                        $("#resubmitToken").val(b.resubmitToken), b.success ? (c = "", d = "", e = b.workShow, 3 == 3 ? "" != e ? (c += '<li data-id="' + e.id + '"><div class="workList c7">' + '<i class="sm_del dn"></i>' + '<i class="sm_edit dn"></i>', e.workUrl && (d = "http://" == e.workUrl.substring(0, 7) || "https://" == e.workUrl.substring(0, 8) ? e.workUrl : "http://" + e.workUrl, c += '<div class="f16">网址：<a href="' + d + '" target="_blank">' + e.workUrl + "</a></div>"), c += "<p>" + e.workDescription + "</p>" + "</div></li>", placeholderFn(), "" != $.trim(h.obj.children(".workShow").children(".slist").html()) && $(a).remove(), h.obj.children(".workShow").children(".slist").prepend(c), h.obj.children(".workShow").removeClass("dn"), h.obj.children(".workEdit").addClass("dn"), h.obj.children(".c_add").removeClass("dn")) : "" != $.trim(h.obj.children(".workShow").children(".slist").html()) ? ($(a).remove(), h.obj.children(".c_add").removeClass("dn")) : (h.obj.children(".workEdit").addClass("dn"), h.obj.children(".workAdd").removeClass("dn")) : 4 == 4 ? (c += '<div class="workList c7"><i class="sm_del dn"></i><i class="sm_edit dn"></i>', e.workUrl && (d = "http://" == e.workUrl.substring(0, 7) || "https://" == e.workUrl.substring(0, 8) ? e.workUrl : "http://" + e.url, c += '<div class="f16">网址：<a href="' + d + '" target="_blank">' + e.workUrl + "</a></div>"), c += "<p>" + e.workDescription + "</p>" + "</div>", placeholderFn(), $(a).parent("li").html(c)) : 2 ==2 && ($(a).parent("li").remove(), "" == $.trim(h.obj.children(".workShow").children(".slist").html()) && h.AddCancel), h.obj.find(".slist li:last-child").addClass("noborder"), $("#lastChangedTime span").text(b.content.refreshTime), $("#resumeScore .which div").text(b.content.infoCompleteStatus.msg), $("#resumeScore .which span").attr("rel", b.content.infoCompleteStatus.nextStage), scoreChange(b.content.infoCompleteStatus.score), k(h.obj), b.content.isNew && changeAllIds(b.content.jsonIds)) : alert(b.msg), $(a).find(":submit").val("保 存").attr("disabled", !1)
                    })
                }
            })
        })
    ...
    window.onbeforeunload = function () {
        ...
        rules: {
            uName: {required: !0, specialchar: !0, checkNum: !0, rangelength: [2, 20]},
            uSex: {required: !1},
            uEducation: {required: !0},
            uWorkyear: {required: !0},
            uStatu: {required: !1},
            uEmail: {required: !0, email: !0, maxlength: 80},
            uMobile: {required: !0, isMobile: !0, maxlength: 30}
        },
        messages: {
            uName: {
                required: "请输入你的真实姓名",
            ...
            uEducation: {required: "请选择最高学历"},
            uWorkyear: {required: "请选择工作年限"},
            uEmail: {
                required: "请输入接收面试通知的常用邮箱",
                email: "请输入有效的常用邮箱，如：vivi@lagou.com",
                maxlength: "请输入有效的常用邮箱，如：vivi@lagou.com"
            },
            uMobile: {required: "请输入手机号码", isMobile: "请输入有效的手机号码", maxlength: "请输入有效的手机号码"}
        },
        errorPlacement: function (a, b) {
            "hidden" == b.attr("type") ? a.appendTo($(b).parent()) : "radio" == b.attr("type") ? a.insertAfter($(b).parents("ul")) : a.insertAfter(b)
        },
        submitHandler: function (a) {
            var b = $('input[name="uName"]', a).val(), c = $('input[name="uSex"]:checked', a).val(),
                d = $('input[name="uEducation"]', a).val(), e = $('input[name="uWorkyear"]', a).val(),
                f = $('input[name="uStatu"]', a).val(), g = $('input[name="uEmail"]', a).val(),
                h = $('input[name="uMobile"]', a).val(), i = $("#pageType").val(), j = $("#resumeId").val(),
                l = $("#resubmitToken").val();
            var json=JSON.stringify({uName: b, uSex: c, uEducation: d, uWorkyear: e, uStatu: f, uEmail: g, uMobile: h});

            $(a).find(":submit").val("保存中...").attr("disabled", !0), $.ajax({
                url: "/resume/saveUserTail",
                type: "POST",
                data:json,
                contentType : "application/json;charset=UTF-8",
                dataType: "json"
                ...
                $("#resubmitToken").val(b.resubmitToken), b.success ? false ? "" : (c = b.resume, d = c.uWorkyear, "应届毕业生" != d ? (d += "工作经验", $("#workExperience h2 span").text("（投递简历时必填）")) : $("#workExperience h2 span").text(""), e = c.uName, "" != c.uSex && (e += " | " + c.uSex), "" != c.uEducation && (e += " | " + c.uEducation), e += " | " + d + "<br />" + c.uMobile + " | " + c.uEmail + "<br />" + c.uStatu, $(".collapsible_menu dt").html(c.uName + "<i></i>"), $("#basicInfo .basicShow span").html(e).parent().removeClass("dn"), $("#basicInfo .basicEdit").addClass("dn"), $("#basicInfo .c_edit").removeClass("dn"), $("#nameVal").val(c.uName), $("#genderVal").val(c.uSex), $("#topDegreeVal").val(c.uEducation), $("#workyearVal").val(c.uWorkyear), $("#currentStateVal").val(c.uStatu), $("#emailVal").val(c.uEmail), $("#telVal").val(c.uMobile), $("#lastChangedTime span").text(b.refreshTime), scoreChange(b.score), k($("#basicInfo"))) : alert(b.msg), $(a).find(":submit").val("保 存").attr("disabled", !1)
            })
            /*上传用户的详细信息*/
        }
        ...
        Edit: function () {
            $("#expectForm").find(":submit").val("保 存").attr("disabled", !1)
        ...
        $("#expectForm").validate({
        rules: {
            preferredLocation: {required: !1},
            jobType: {required: !1},
            preferredFunction: {required: !1, specialchar: !0, checkNum: !0, minlength: 2, maxlength: 100},
            salaryExpection: {required: !1}
        },
        messages: {
            preferredFunction: {
        ...
        submitHandler: function (a) {
            var c = $('input[name="preferredLocation"]', a).val(), d = $('input[name="jobType"]:checked', a).val(),
                e = "期望职位，如：产品经理" != $('input[name="preferredFunction"]', a).val() ? $('input[name="preferredFunction"]', a).val() : "",
                f = $('input[name="salaryExpection"]', a).val(), g = $("#resumeId").val(), h = $("#resubmitToken").val();
                var json =JSON.stringify({preferredLocation: c, jobType: d, preferredFunction: e, salaryExpection: f});
                alert(json);
            $(a).find(":submit").val("保存中...").attr("disabled", !0), $.ajax({
                url: "/resume/saveCareerObjective",
                contentType : "application/json;charset=UTF-8",
                type: "POST",
                data: json,
                dataType: "json"
                ...
                if ($("#resubmitToken").val(g.resubmitToken), g.success) {
                    if (c || d || e || f) {
                        var h = g.resume.preferredFunction;
                        b.obj.find(".expectShow").children("span").html(h).parent().removeClass("dn"), b.obj.find(".c_edit").removeClass("dn"), b.obj.find(".expectEdit").addClass("dn"), b.obj.find("#expectJobVal").val(g.resume.preferredFunction), b.obj.find("#expectCityVal").val(g.resume.preferredLocation), b.obj.find("#typeVal").val(g.resume.jobType), b.obj.find("#expectPositionVal").val(g.content.resume.preferredFunction), b.obj.find("#expectSalaryVal").val(g.resume.salaryExpection), b.expectJobVal = g.resume.preferredFunction, b.expectCityVal = g.resume.preferredLocation, b.typeVal = g.resume.positionType, b.expectPositionVal = g.resume.preferredFunction, b.expectSalaryVal = g.resume.salaryExpection, $("#lastChangedTime span").text(g.refreshTime), $("#resumeScore .which div").text(g.content.infoCompleteStatus.msg), $("#resumeScore .which span").attr("rel", g.content.infoCompleteStatus.nextStage), scoreChange(g.content.infoCompleteStatus.score), k(b.obj)
        ...
        $(this).validate({
            ...
            submitHandler: function (a) {
               ...
               var startTime=e+"-"+f;
                var endTime=g+"-"+h;
                var json=JSON.stringify({ company: b, jobTitle: d, startTime:startTime, endTime:endTime});
                $(a).find(":submit").val("保存中...").attr("disabled", !0), $.ajax({
                    url:"/resume/getWorkExperience",
                    type: "POST",
                    contentType : "application/json;charset=UTF-8",
                    data: json,
                    dataType: "json"
                    ...
                    if ($("#resubmitToken").val(b.resubmitToken), b.success) {
                        d=b.workExperiences;
                        e += 0 == f % 2 ? '<li data-id="' + d.id + '" class="clear">' : '<li data-id="' + "fdasf" + '">' ,e += '<i class="sm_del dn"></i><i class="sm_edit dn"></i><span class="c9" data-startYear="' + d.startTime.split("-")[0] + '" data-endYear="' + d.endTime.split("-")[0] + '" data-startMonth = "' + d.startTime.split("-")[1] + '" data-endMonth = "' + d.endTime.split("-")[1] + '">' + d.startTime + "-" + d.endTime + "</span>" + "<div>" + '<img src="' + ctx + "/" + d.companyLogo + '" width="56" height="56" alt="' + d.company + '" />' + "<h3>" + d.jobTitle + "</h3>" + "<h4>" + d.company + "</h4>" + "</div>" + "</li>";
                        c.obj.children(".c_add").removeClass("dn"), c.obj.children(".experienceShow").children(".experienceForm").hide(), c.obj.children(".experienceShow").children(".wlist").html(e).parent().removeClass("dn"), c.obj.children(".experienceEdit").addClass("dn"), $("#lastChangedTime span").text(b.refreshTime), $("#resumeScore .which div").text("恭喜你完成了这项"), $("#resumeScore .which span").attr("rel", "无敌"), scoreChange(b.score), k(c.obj), "无敌" && changeAllIds("无敌")
                    } else alert(b.msg);
                    $(a).find(":submit").val("保 存").attr("disabled", !1)
                })
            }
        ...
        $(this).validate({
            ...
            submitHandler: function (a) {
                var b = $('input[name="schoolName"]', a).val(), c = $('input[name="degree"]', a).val(),
                    ...
                    j = $("#resubmitToken").val();
                var json=JSON.stringify({school:b,startDate:e,major:d,endDate:g,degree:c});

                $(a).find(":submit").val("保存中...").attr("disabled", !0), $.ajax({
                    url: "/resume/getEducationBackround",
                    type: "POST",
                    contentType : "application/json;charset=UTF-8",
                    data: json,
                    dataType: "json"
                    ...
                    var c, d, e;
                    if ($("#resubmitToken").val(b.resubmitToken), b.success) {
                        c = b.educationExperiences, d = "", d += 0 == e % 2 ? '<li data-id="' + c.id + '" class="clear">' : '<li data-id="' + c.id + '">', d += '<i class="sm_del dn"></i><i class="sm_edit dn"></i><span class="c9" data-startY="' + c.startDate + '" data-endY="' + c.endDate + '">' + c.startDate + "-" + c.endDate + "</span>" + "<div>" + '<h3 data-schName="' + c.school + '">' + c.school + "</h3>" + '<h4 data-proName="' + c.major + '" data-degree="' + c.degree + '">' + c.degree + "，" + c.major + "</h4>" + "</div>" + "</li>";
                        f.obj.children(".c_add").removeClass("dn"), f.obj.children(".educationalShow").children(".educationalForm").hide(), f.obj.children(".educationalShow").children(".elist").html(d).parent().removeClass("dn"), f.obj.children(".educationalEdit").addClass("dn"), $("#lastChangedTime span").text(b.refreshTime), $("#resumeScore .which div").text(b.msg), $("#resumeScore .which span").attr("rel", b.content), scoreChange(b.score), k(f.obj), b.isNew && changeAllIds(b.jsonIds)
                    } else alert(b.msg);
                    $(a).find(":submit").val("保 存").attr("disabled", !1)
                })
            }
        ...
        $(".descriptionForm").find(":submit").val("保 存").attr("disabled", !1);
        g.Edit()
        ...
        rules: {selfDescription: {required: !1}}, submitHandler: function (a) {
            var b = $('textarea[name="selfDescription"]', a).val(), c = $("#resumeId").val(),
                d = $("#resubmitToken").val();
            var json=JSON.stringify({description:b});
            alert(json);
            $(a).find(":submit").val("保存中...").attr("disabled", !0), $.ajax({
                url:"/resume/getSelfAssessment",
                type: "POST",
                contentType :"application/json;charset=UTF-8",
                data:json,
                dataType: "json"
                ...
                var c, d;
                $("#resubmitToken").val(b.resubmitToken), b.success ? (c = b.resume, d = "", c.description ? (d = c.description, g.text = c.description, g.obj.children(".c_edit").removeClass("dn"), g.obj.children(".descriptionShow").html(d).removeClass("dn"), g.obj.children(".descriptionEdit").addClass("dn"), $("#lastChangedTime span").text(b.refreshTime), $("#resumeScore .which div").text(b.msg), $("#resumeScore .which span").attr("rel", b.nextStage), scoreChange(b.score), k(g.obj)) : (g.text = "", g.obj.children(".c_edit").addClass("dn"), g.obj.children(".descriptionShow").addClass("dn"), g.obj.children(".descriptionEdit").addClass("dn"), g.obj.children(".descriptionAdd").removeClass("dn"), $("#lastChangedTime span").text(b.refreshTime), $("#resumeScore .which div").text(b.msg), $("#resumeScore .which span").attr("rel", b.nextStage), scoreChange(b.score), k(g.obj)), b.content.isNew && changeAllIds(b.jsonIds)) : alert(b.msg), $(a).find(":submit").val("保 存").attr("disabled", !1)
            })
        }
    }), h = {
